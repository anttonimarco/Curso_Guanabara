...
name = str(input('\033[32mDigite seu nome completo: \033[m')).strip()  # strip não conta espaços vazios.
...
separa = name.split()
print('\033[36mSeu primeiro nome é\033[m {} \033[36me ele tem \033[m{} \033[36mletras\033[m'.format(separa[0],
                                                                                                    len(separa[0])))
